...
#define NB_LOADCELL 2    /*--- Number of Loads    ---*/

long t;                   /*--- Loop period control ---*/

int num_LoadCell = 1;     /*--- Load cell number. Front cell (= 0) by default to start, rear cell is (= 1) ---*/

int i;                    /*--- Loop control ---*/

float LoadCellValue[NB_LOADCELL];
float LoadCellFactor[] = {935.0, 1013.0};
